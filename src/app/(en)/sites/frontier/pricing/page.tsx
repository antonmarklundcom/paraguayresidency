  ...
  return (
    <Section className="pb-[calc(4rem+env(safe-area-inset-bottom))] md:pb-[var(--space-16)]">
      <Container width="narrow">
        ...
        <Heading level={1} className="mt-[var(--space-8)]">Know the service fee before building your Paraguay plan B</Heading>
        <p className="mt-[var(--space-4)] text-(length:--text-lg) text-[var(--fg-muted)]">For Americans and expats keeping Paraguay as an option, the quote starts with your nationality, documents, route and travel plans. We agree the work and fixed service fee before you commit. Your checklist and who is applying set the scope, so a self-service calculator cannot replace that conversation.</p>
