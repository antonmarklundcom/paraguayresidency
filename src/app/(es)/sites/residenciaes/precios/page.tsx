...
export default function Page() {
  return (
    <Section className="pb-[calc(4rem+env(safe-area-inset-bottom))] md:pb-[var(--space-16)]">
      ...
      <StickyCta formId="inquiry" label="Habla con nosotros" />
      </Container>
    </Section>
  );
}
