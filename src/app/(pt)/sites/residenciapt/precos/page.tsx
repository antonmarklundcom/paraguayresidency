    ...
    <Section className="pb-[calc(4rem+env(safe-area-inset-bottom))] md:pb-[var(--space-16)]">
      <Container width="narrow">
        ...
        <div id="inquiry" className="scroll-mt-6 mt-[var(--space-16)] rounded-[var(--radius-brand)] border border-[var(--border)] bg-[var(--surface-alt)] p-[var(--space-8)]">
          ...
          <p className="mt-[var(--space-4)]">Diga sua nacionalidade, rota e prazo. Confirmamos o escopo por escrito e depois detalhamos o honorário fixo e os custos separados, antes de você decidir.</p>
          <div className="mt-[var(--space-6)]"><Button href="/contact">Escreva para nós</Button></div>
